...
- **Central de Comparações Dinâmicas (Target Dinâmico)**: Dropdown interativo para escolher qualquer indicador-alvo (Taxas de Aprovação, SAEB, IDEB, Rendimento, Metas) e o grupo contrafactual de benchmarking (Rede Estadual Regular, Não CM Geral ou Pareamento Municipal).
- **Aprovações em Destaque**: Análise aprofundada de aprovação escolar geral, por série/ano (6º ao 9º ano ou 1ª à 3ª série), faixas de concentração (<85% a 100%) e dispersão entre Aprovação vs Nota no SAEB.
- **Indicadores do SAEB**: Proficiências em Matemática, Língua Portuguesa e Nota Média Padronizada de 0 a 10.
- **Indicadores do IDEB**: IDEB Observado, Metas Projetadas do MEC e Indicador de Rendimento ($P$).
- **Mapa Geoespacial Interativo**: Comparação municipal com mapa de dispersão geográfica do Paraná por etapa de ensino.
